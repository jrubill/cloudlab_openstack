...
openstack port create --network ${network_id} --fixed-ip subnet=${subnet_id},ip-address=10.11.10.21 Compute1
openstack port create --network ${network_id} --fixed-ip subnet=${subnet_id},ip-address=10.11.10.22 Compute2
openstack port create --network ${network_id} --fixed-ip subnet=${subnet_id},ip-address=10.11.10.23 Compute3
openstack port create --network ${network_id} --fixed-ip subnet=${subnet_id},ip-address=10.11.10.24 Headnode
openstack port create --network ${network_id} --fixed-ip subnet=${subnet_id},ip-address=10.11.10.25 Storage1
openstack port create --network ${network_id} --fixed-ip subnet=${subnet_id},ip-address=10.11.10.26 Storage2
...
wget -O /tmp/setup/Nilla.vmdk https://clemson.box.com/shared/static/v9helcewhtp14rrh8usgf5pnr6ohmt4r.vmdk
glance image-create --name Nilla --disk-format vmdk --visibility public --container-format bare < /tmp/setup/Nilla.vmdk
...
image_id=`openstack image list -f value | grep Nilla | cut -d' ' -f 1`
...
openstack server create --flavor m1.medium --security-group $security_id --image Nilla --nic port-id=$port_id headnode

port_id=`openstack port list -f value | grep Compute1 | cut -d' ' -f 1`
openstack server create --flavor m1.medium --security-group $security_id --image Nilla --nic port-id=$port_id Compute1

port_id=`openstack port list -f value | grep Compute2 | cut -d' ' -f 1`
openstack server create --flavor m1.medium --security-group $security_id --image Nilla --nic port-id=$port_id Compute2

port_id=`openstack port list -f value | grep Compute3 | cut -d' ' -f 1`
openstack server create --flavor m1.medium --security-group $security_id --image Nilla --nic port-id=$port_id Compute3

port_id=`openstack port list -f value | grep Storage1 | cut -d' ' -f 1`
openstack server create --flavor m1.medium --security-group $security_id --image Nilla --nic port-id=$port_id Storage1

port_id=`openstack port list -f value | grep Storage2 | cut -d' ' -f 1`
openstack server create --flavor m1.medium --security-group $security_id --image Nilla --nic port-id=$port_id Storage2
